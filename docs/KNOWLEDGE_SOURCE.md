...
- Download the original PDF unchanged from the NOAA repository in M3.
...
- If the repository file/license differs from this record at implementation time, stop and update the decision log before committing the asset.
...
License rechecked at:
Repository strategy: committed original / verified download script
```
